      ...
      <div className="container mx-auto flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center lg:hidden">
          <button className="text-black mr-4 focus:outline-none">
           <div className="w-6 h-6 text-red-500"> <FaShoppingCart  /> 
            </div>
          </button>
        ...
        {/* Navigation Links */}
        <nav className={`lg:flex ${isMenuOpen ? 'absolute top-full left-0 w-full bg-white border-t border-gray-200' : 'hidden'} lg:w-auto`}>
          <ul className="flex flex-col lg:flex-row lg:space-x-8 text-black lg:items-center">
            <li className="py-2 font-bold lg:py-0 border-b border-gray-200 lg:border-none hover:text-gray-600 pl-4 lg:pl-0">
              <Link to="/" className="hover:text-gray-400" onClick={() => setIsMenuOpen(false)}>Car Listings</Link>
            </li>
            <li className="py-2 lg:py-0 font-bold  border-b border-gray-200 lg:border-none hover:text-gray-600 pl-4 lg:pl-0">
              <Link to="/about-us" className="hover:text-gray-400" onClick={() => setIsMenuOpen(false)}>About Us</Link>
            </li>
            <li className="py-2 lg:py-0 font-bold hover:text-gray-600 pl-4 lg:pl-0">
              <Link to="/contact-us" className="hover:text-gray-400" onClick={() => setIsMenuOpen(false)}>Contact Us</Link>
            </li>
            <li className="py-2 lg:py-0 font-bold hover:text-gray-600 pl-4 lg:pl-0">
              <Link to="/sell" className="hover:text-gray-400" onClick={() => setIsMenuOpen(false)}>Sell Your Car</Link>
            </li>
          </ul>
        </nav>
      </div>
